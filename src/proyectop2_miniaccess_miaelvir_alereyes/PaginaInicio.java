...
public class PaginaInicio extends javax.swing.JFrame {
    ...
    ArrayList<String> basesDiagrama = new ArrayList<>();
    /**
    ...
    private void initComponents() {
        ...
        jd_stick = new javax.swing.JDialog();
        ...
        bt_salir.setFont(new java.awt.Font("Calibri Light", 1, 12)); // NOI18N
        ...
        jLabel40.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/moño larguito.png"))); // NOI18N
        jPanel19.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 150, 270));
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel19, javax.swing.GroupLayout.PREFERRED_SIZE, 488, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jp_diagrama.setLayout(null);
        jPanel18.add(jp_diagrama, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 46, 690, 440));
        ...
        bt_dibBase.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bt_dibBaseMouseClicked(evt);
            }
        });
        ...
        jPanel18.add(jToolBar3, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 388, 25));
        ...
        jMenu4.setFont(new java.awt.Font("Bell MT", 2, 14)); // NOI18N
        ...
        jmi_diagramarBase.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmi_diagramarBaseActionPerformed(evt);
            }
        });
        popup_opcionesBases.add(jmi_diagramarBase);

        jd_stick.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel20.setBackground(new java.awt.Color(255, 204, 204));
        jPanel20.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel42.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/moñoEditado-removebg-preview.png"))); // NOI18N
        jPanel20.add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, -1, -1));

        jLabel43.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/moñoEditado-removebg-preview.png"))); // NOI18N
        jPanel20.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, -1, -1));

        jLabel41.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/gatis.jpg"))); // NOI18N
        jLabel41.setText("jLabel41");
        jPanel20.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(47, 34, 343, 288));

        jd_stick.getContentPane().add(jPanel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 440, 360));
...
//WHERE
    ...
    private void jl_abrirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jl_abrirMouseClicked
        ...
        fileChooser.setFileFilter(filtro);
         int sel = fileChooser.showOpenDialog(this);
    ...
    private void bt_dibBaseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_dibBaseMouseClicked
        
        String nombreBase = JOptionPane.showInputDialog("Ingrese el nombre de la Base de Datos");
        int tablas = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de tablas que contiene: "));
        String [] nombres = new String[tablas];
        String [] campos = new String[tablas];
        for (int i = 0; i < nombres.length; i++) {
            String tablita = JOptionPane.showInputDialog("Ingrese el nombre de la tabla "+(i+1)+" y sus columnas en parentesis Alumnos(Nombre,Edad): ");
            //String campo = JOptionPane.showInputDialog("Ingrese los campos separados por comas");
            nombres[i] = tablita; 
            basesDiagrama.add(nombreBase+"|"+tablita);
        }
        
        
        if (contTablas > 0) {
            PanelesBases base = new PanelesBases(jp_diagrama, new JLabel(nombreBase), tablas, nombres);
            base.setLocation(jp_diagrama.getX()+base.getWidth()+5, jp_diagrama.getY());
        }else if (contTablas == 0) {
            PanelesBases base = new PanelesBases(jp_diagrama, new JLabel(nombreBase), tablas, nombres);
            base.setLocation(jp_diagrama.getX(), jp_diagrama.getY());
    ...
    }//GEN-LAST:event_bt_dibBaseMouseClicked

    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        jp_diagrama.removeAll();
        jp_diagrama.revalidate();
        jp_diagrama.repaint();
        basesDiagrama = new ArrayList<>();
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        for (int i = 0; i < basesDiagrama.size(); i++) {
            String temp = basesDiagrama.get(i);
      
            String [] split1 = temp.split("\\|"); //Unitec | Alumnos(b1,b2)
            
            String [] split2 = split1[1].split("\\(");//b1,b2)- pos1
            
            String [] nomTabla = split2[0].split("\\(");//nomTabla pos 0
            String [] split3 = split2[1].split("\\)");//b1,b2- pos0
            String [] columnas = split3[0].split(",");//campos separados 
            String nombreB = split1[0];
            String nombreT = nomTabla[0];
            boolean existe = false;
            //BasedeDatos basecita = null;
            DefaultTreeModel modelo = (DefaultTreeModel)jtree_baseddatos.getModel();
            DefaultMutableTreeNode nodoRaiz = (DefaultMutableTreeNode) modelo.getRoot();
            for (int b = 0; b < nodoRaiz.getChildCount(); b++) {
                DefaultMutableTreeNode nodoHijo = (DefaultMutableTreeNode) nodoRaiz.getChildAt(b);
                if (nodoHijo.getUserObject() instanceof BasedeDatos) {
                    BasedeDatos base = (BasedeDatos) nodoHijo.getUserObject();
                    String nom = base.getNombre();
                    if (nom.equals(nombreB)) {
                        //escribir archivo de la tabla y ir metiendolo en nodo para meterlo en el nodohijo
                        existe = true; 
                        File archivo = null;
                        FileWriter fw = null;
                        BufferedWriter bw = null;
                        ...
                        try {
                            ...
                            archivo = new File(".\\" + nombreB + "\\" + nombreT + ".txt");
                            ...
                            bw.write("★ENCABEZADO");
                            bw.newLine();
                            bw.write("nombre: " + nombreT);
                            bw.newLine();
                            bw.write("creador(a): " + userActual.getUsuario());
                            bw.newLine();
                            bw.write("fecha_creacion: " + fecha);
                            bw.newLine();
                            bw.write("atributos: " + split3[0]);
                            bw.newLine();
                            bw.newLine();
                        ...
                        DefaultMutableTreeNode nodoTabla = new DefaultMutableTreeNode(archivo);
                        nodoHijo.add(nodoTabla);
                        modeloArbol.reload();
                        jtree_baseddatos.setModel(modeloArbol);
            ...
            if (existe == false) {
                DefaultMutableTreeNode base = new DefaultMutableTreeNode(new BasedeDatos(nombreB));
                File dir = new File("./" + nombreB);
                dir.mkdir(); 
                        File archivo = null;
                        FileWriter fw = null;
                        BufferedWriter bw = null;
                        ...
                        //hacer scripts y users 
                        File script = new File("./"+nombreB+"/script");
                        DefaultMutableTreeNode nodo_s = new DefaultMutableTreeNode(script);
                        base.add(nodo_s);
                        
                            File usuarios_base = new File("./" + nombreB + "/usuarios");
                            DefaultMutableTreeNode nodo_u = new DefaultMutableTreeNode(usuarios_base);
                            base.add(nodo_u);
                            ArrayList<Usuario> permitidos = new ArrayList<>();
                            for (int j = 0; j < usuarios.size(); j++) {
                                ...
                                for (int k = 0; k < usuarios.get(j).getBases().size(); k++) {
                                    ...
                                    if (usuarios.get(j).getBases().get(k).equals(nombreB)) {
                                        permitidos.add(this.usuarios.get(j));
                                    }
                                }
                            }
            ...
            //                    BufferedWriter bw = null;
                            try {
                                ...
                                bw.write("★ Base - " + nombreB);
                                bw.newLine();
                                bw.write("★ Usuarios ★");
                                bw.newLine();
                                bw.newLine();
                                for (int j = 0; j < permitidos.size(); j++) {
                                    Usuario p = permitidos.get(j);
                                    bw.write("- Usuario: " + p.getUsuario() + " | Contraseña: " + p.getContrasenia());
                                    bw.newLine();
                                }
                                bw.flush();
                                bw.close();
                        ...
                        modeloArbol.reload();
                        jtree_baseddatos.setModel(modeloArbol); 
            }//si no existe ya esa base de datos
    ...
    private void jmi_diagramarBaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmi_diagramarBaseActionPerformed
        String nombreBase = base_seleccionada.getNombre();
        
        DefaultMutableTreeNode nodobase = (DefaultMutableTreeNode) nodo_seleccionado;
        
          String ar [] = new String [nodobase.getChildCount()-2];
          int cont=0; 
         
        for (int i = 0; i < nodobase.getChildCount(); i++) {
            DefaultMutableTreeNode temp = (DefaultMutableTreeNode) nodobase.getChildAt(i);
            
            File archivo = (File) temp.getUserObject();
            String pat = archivo.getPath();
            String [] paths = pat.split("\\\\");
            
            
            if(!(paths[2].contains("script")) && !(paths[2].contains("usuarios"))){
               File archivo2 = (File) temp.getUserObject();
               String nombret [] = paths[2].split("\\.");
               FileReader fr = null;
               BufferedReader br = null;
        ...
        jp_diagrama.removeAll();
        PanelesBases panelito = new PanelesBases(jp_diagrama,   new JLabel(nombreBase), ar.length, ar);
        panelito.setLocation(jp_diagrama.getX(), jp_diagrama.getY());
        jp_diagrama.revalidate();
        jp_diagrama.repaint();
    ...
    }//GEN-LAST:event_jmi_diagramarBaseActionPerformed
...
//    }
    ...
    private javax.swing.JDialog jd_stick;
